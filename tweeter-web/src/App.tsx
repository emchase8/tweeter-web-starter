        ...
        <Route
          ...
          element={
            <StatusItemScroller
              ...
              featureURL="/feed"
              presentorFactory={(listener: StatusItemView) => new FeedPresenter(listener)}
            />
          }
        />
        <Route
          ...
          element={
            <StatusItemScroller
              ...
              featureURL="/story"
              presentorFactory={(listener: StatusItemView) => new StoryPresenter(listener)}
            />
          }
        />
        <Route
          ...
          element={
            <UserItemScroller
              ...
              presentorFactory={(listener: UserItemView) =>
